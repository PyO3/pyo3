...
class ComplexEnum:
    ...
    class MultiFieldStruct(ComplexEnum):
        ...
        def __new__(cls, /, a: int, b: float, c: bool) -> Self: ...
        @property
        def a(self, /) -> int: ...
        @property
        def b(self, /) -> float: ...
    ...
    class VariantWithDefault(ComplexEnum):
        ...
        def __new__(cls, /, a: int = 42, b: str | None = None) -> Self: ...
        @property
        def a(self, /) -> int: ...
        @property
        def b(self, /) -> str | None: ...
...
class TupleEnum:
    ...
    class Full(TupleEnum):
        ...
        def __getitem__(self, key: int, /) -> Any: ...
        def __len__(self, /) -> int: ...
        def __new__(cls, /, _0: int, _1: float, _2: bool) -> Self: ...
    ...
    class FullWithDefault(TupleEnum):
        ...
        def __getitem__(self, key: int, /) -> Any: ...
        def __len__(self, /) -> int: ...
        def __new__(cls, /, _0: int = 1, _1: float = 1.0, _2: bool = True) -> Self: ...
