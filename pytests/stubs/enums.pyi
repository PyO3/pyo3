...
class ComplexEnum:
    ...
    class Float(ComplexEnum):
        ...
        def __new__(cls, /, f: SupportsFloat | SupportsIndex) -> ComplexEnum.Float: ...
        @property
        def f(self, /) -> float: ...
    ...
    class Int(ComplexEnum):
        ...
        def __new__(cls, /, i: SupportsIndex) -> ComplexEnum.Int: ...
        @property
        def i(self, /) -> int:
            """
            An integer
    ...
    class VariantWithDefault(ComplexEnum):
        ...
        def __new__(
            cls, /, a: SupportsIndex = 42, b: str | None = None
...
class SimpleTupleEnum:
    ...
    class Int(SimpleTupleEnum):
        ...
        def __getitem__(self, key: SupportsIndex, /) -> Any: ...
        def __len__(self, /) -> int: ...
        def __new__(cls, /, _0: SupportsIndex) -> SimpleTupleEnum.Int: ...
