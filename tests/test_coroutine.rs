...
fn noop_coroutine() {
    ...
    Python::with_gil(|gil| {
        ...
        py_run_bound!(gil, noop, &handle_windows(test));
    })
}
...
fn test_coroutine_qualname() {
    ...
    Python::with_gil(|gil| {
        ...
        py_run_bound!(gil, *&locals, &handle_windows(test));
    })
}
...
fn sleep_0_like_coroutine() {
    ...
    Python::with_gil(|gil| {
        ...
        py_run_bound!(gil, sleep_0, &handle_windows(test));
    })
}
...
fn sleep_coroutine() {
    Python::with_gil(|gil| {
        ...
        py_run_bound!(gil, sleep, &handle_windows(test));
    })
}
...
fn coroutine_panic() {
    ...
    Python::with_gil(|gil| {
        ...
        try:
            ...
            assert False;
        "#;
        py_run_bound!(gil, panic, &handle_windows(test));
    })
}
