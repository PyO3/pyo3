...
pub unsafe fn PyFrozenSet_CheckExact(ob: *mut PyObject) -> c_int { unsafe {
    (Py_TYPE(ob) == &raw mut PyFrozenSet_Type) as c_int
}}

#[inline]
#[cfg(not(any(PyPy, RustPython)))]
pub unsafe fn PyFrozenSet_Check(ob: *mut PyObject) -> c_int { unsafe {
...
#[inline]
#[cfg(not(any(PyPy, RustPython)))]
pub unsafe fn PyAnySet_CheckExact(ob: *mut PyObject) -> c_int { unsafe {
    (Py_TYPE(ob) == &raw mut PySet_Type || Py_TYPE(ob) == &raw mut PyFrozenSet_Type) as c_int
}}

#[inline]
#[cfg(not(RustPython))]
pub unsafe fn PyAnySet_Check(ob: *mut PyObject) -> c_int { unsafe {
...
pub unsafe fn PySet_CheckExact(op: *mut PyObject) -> c_int { unsafe {
    crate::Py_IS_TYPE(op, &raw mut PySet_Type)
}}

#[inline]
#[cfg(not(any(PyPy, RustPython)))]
pub unsafe fn PySet_Check(ob: *mut PyObject) -> c_int { unsafe {
