...
extern_libpython! {
    ...
    #[cfg(not(Py_3_15))]
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPy_GetProgramName")]
    #[cfg_attr(
        Py_3_13,
    ...
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPy_GetVersion")]
