...
extern_libpython! {
    ...
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyList_New")]
    pub fn PyList_New(size: Py_ssize_t) -> *mut PyObject;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyList_Size")]
    ...
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyList_SetItem")]
    ...
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyList_Append")]
    pub fn PyList_Append(arg1: *mut PyObject, arg2: *mut PyObject) -> c_int;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyList_GetSlice")]
    ...
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyList_Sort")]
    pub fn PyList_Sort(arg1: *mut PyObject) -> c_int;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyList_Reverse")]
    pub fn PyList_Reverse(arg1: *mut PyObject) -> c_int;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyList_AsTuple")]
