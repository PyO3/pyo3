...
include!("Include/Python.rs");

// Additional headers that are not exported by Python.h
#[deprecated(note = "Python 3.12")]
#[path = "Include/structmember.rs"]
pub mod structmember;

// For historical reasons these are included inline in pyo3-ffi
// instead of being `pub mod` like structmember.
#[cfg(not(Py_LIMITED_API))]
include!("Include/datetime.rs");
include!("Include/frameobject.rs");
include!("Include/marshal.rs");
