...
extern_libpython! {
    ...
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_New")]
    pub fn PyDict_New() -> *mut PyObject;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_GetItem")]
    pub fn PyDict_GetItem(mp: *mut PyObject, key: *mut PyObject) -> *mut PyObject;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_GetItemWithError")]
    ...
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_DelItem")]
    pub fn PyDict_DelItem(mp: *mut PyObject, key: *mut PyObject) -> c_int;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_Clear")]
    pub fn PyDict_Clear(mp: *mut PyObject);
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_Next")]
    pub fn PyDict_Next(
        mp: *mut PyObject,
        pos: *mut Py_ssize_t,
    ...
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_Keys")]
    pub fn PyDict_Keys(mp: *mut PyObject) -> *mut PyObject;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_Values")]
    pub fn PyDict_Values(mp: *mut PyObject) -> *mut PyObject;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_Items")]
    pub fn PyDict_Items(mp: *mut PyObject) -> *mut PyObject;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_Size")]
    pub fn PyDict_Size(mp: *mut PyObject) -> Py_ssize_t;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_Copy")]
    pub fn PyDict_Copy(mp: *mut PyObject) -> *mut PyObject;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_Contains")]
    pub fn PyDict_Contains(mp: *mut PyObject, key: *mut PyObject) -> c_int;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_Update")]
    pub fn PyDict_Update(mp: *mut PyObject, other: *mut PyObject) -> c_int;
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_Merge")]
    ...
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_GetItemString")]
    ...
    #[cfg_attr(all(PyPy, not(Py_3_12)), link_name = "PyPyDict_DelItemString")]
