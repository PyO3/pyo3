...
impl<'a> PyClassImplsBuilder<'a> {
    ...
    fn impl_extractext(&self, ctx: &Ctx) -> TokenStream {
        ...
        if self.attr.options.frozen.is_some() {
            quote! {
                impl<'a, 'holder, 'py> #pyo3_path::impl_::extract_argument::PyFunctionArgument<'a, 'holder, 'py> for &'holder #cls
                {
                    type Holder = ::std::option::Option<#pyo3_path::PyRef<'a, 'py, #cls>>;
            ...
            quote! {
                ...
                impl<'a, 'holder, 'py> #pyo3_path::impl_::extract_argument::PyFunctionArgument<'a, 'holder, 'py> for &'holder mut #cls
                {
                    type Holder = ::std::option::Option<#pyo3_path::PyRefMut<'a, 'py, #cls>>;
