...
#[allow(deprecated)]
impl<T: PyClass> IntoPy<PyObject> for PyRef<'_, '_, T> {
...
#[allow(deprecated)]
impl<T: PyClass> IntoPy<PyObject> for &'_ PyRef<'_, '_, T> {
    fn into_py(self, py: Python<'_>) -> PyObject {
        unsafe { PyObject::from_borrowed_ptr(py, self.inner.as_ptr()) }
    }
}
...
unsafe impl<T: PyClass> AsPyPointer for PyRef<'_, '_, T> {
...
#[allow(deprecated)]
impl<T: PyClass<Frozen = False>> IntoPy<PyObject> for PyRefMut<'_, '_, T> {
    fn into_py(self, py: Python<'_>) -> PyObject {
        unsafe { PyObject::from_borrowed_ptr(py, self.inner.as_ptr()) }
    }
}
...
#[allow(deprecated)]
impl<T: PyClass<Frozen = False>> IntoPy<PyObject> for &'_ PyRefMut<'_, '_, T> {
    fn into_py(self, py: Python<'_>) -> PyObject {
