...
mod bufferinfo {
    ...
    pub type getbufferproc =
        unsafe extern "C" fn(arg1: *mut ::ffi3::PyObject,
                             arg2: *mut Py_buffer,
                             arg3: c_int)
                             -> c_int;
...
mod typeobject {
    ...
    pub const PySequenceMethods_INIT : PySequenceMethods = PySequenceMethods {
        ...
        sq_repeat: None,
        sq_item: None,
        was_sq_slice:  0usize as *mut _,
        sq_ass_item: None,
        was_sq_ass_slice: 0usize as *mut _,
        sq_contains: None,
        ...
        ($tp_as_async:ident, $($tail:tt)*) => {
            as_expr! {
                PyTypeObject {
                    ...
                    tp_getattr: None,
                    tp_setattr: None,
                    $tp_as_async: 0usize as *mut _,
                    tp_repr: None,
                    tp_as_number: 0usize as *mut _,
                    tp_as_sequence: 0usize as *mut _,
                    tp_as_mapping: 0usize as *mut _,
                    tp_hash: None,
                    tp_call: None,
                    tp_str: None,
                    tp_getattro: None,
                    tp_setattro: None,
                    tp_as_buffer: 0usize as *mut _,
                    tp_flags: ffi3::object::Py_TPFLAGS_DEFAULT,
                    tp_doc: 0usize as *const _,
                    tp_traverse: None,
                    tp_clear: None,
                    tp_richcompare: None,
                    tp_weaklistoffset: 0,
                    tp_iter: None,
                    tp_iternext: None,
                    tp_methods: 0usize as *mut _,
                    tp_members: 0usize as *mut _,
                    tp_getset: 0usize as *mut _,
                    tp_base: 0usize as *mut _,
                    tp_dict: 0usize as *mut _,
                    tp_descr_get: None,
                    tp_descr_set: None,
                    tp_dictoffset: 0,
                    tp_init: None,
                    ...
                    tp_free: None,
                    tp_is_gc: None,
                    tp_bases: 0usize as *mut _,
                    tp_mro: 0usize as *mut _,
                    tp_cache: 0usize as *mut _,
                    tp_subclasses: 0usize as *mut _,
                    tp_weaklist: 0usize as *mut _,
                    tp_del: None,
                    tp_version_tag: 0,
                    $($tail)*
                }
    ...
    #[inline]
    pub unsafe fn PyHeapType_GET_MEMBERS(etype: *mut PyHeapTypeObject) -> *mut ffi3::structmember::PyMemberDef {
