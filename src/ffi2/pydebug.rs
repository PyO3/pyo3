...
extern "C" {
    ...
    #[cfg_attr(PyPy, link_name = "PyPy_TabcheckFlag")]
    pub static mut Py_TabcheckFlag: c_int;
    #[cfg_attr(PyPy, link_name = "PyPy_UnicodeFlag")]
    ...
    #[cfg_attr(PyPy, link_name = "PyPy_DivisionWarningFlag")]
    ...
    #[cfg_attr(PyPy, link_name = "_PyPy_QnewFlag")]
    pub static mut _Py_QnewFlag: c_int;
    #[cfg_attr(PyPy, link_name = "PyPy_Py3kWarningFlag")]
