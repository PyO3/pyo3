...
use crate::{
    ...
    sync::GILOnceCell,
    types::{PyAnyMethods, PyCFunction, PyDict, PyModule, PyModuleMethods},
    Bound, Py, PyClass, PyObject, PyResult, PyTypeInfo, Python,
};
...
impl ModuleDef {
    ...
    pub fn make_module(&'static self, py: Python<'_>, gil_used: bool) -> PyResult<Py<PyModule>> {
        ...
        static SIMPLE_NAMESPACE: GILOnceCell<PyObject> = GILOnceCell::new();
