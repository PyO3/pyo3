...
//             // Now test that converting a PyDateTime with tzinfo to a PrimitiveDateTime fails
//             let res: PyResult<OffsetDateTime<Utc>> = py_datetime.extract();
//             assert_eq!(
//                 res.unwrap_err().value(py).repr().unwrap().to_string(),
...
//             // Now test that converting a PyDateTime with tzinfo to a PrimitiveDateTime fails
//             let res: PyResult<OffsetDateTime<FixedOffset>> = py_datetime.extract();
//             assert_eq!(
//                 res.unwrap_err().value(py).repr().unwrap().to_string(),
//                 "TypeError('expected a datetime with non-None tzinfo')"
//             );
...
//             );
//             assert_eq!(
//                 none.extract::<OffsetDateTime<Utc>>()
//                     .unwrap_err()
//                     .to_string(),
//                 "TypeError: 'NoneType' object cannot be converted to 'PyDateTime'"
//             );
//             assert_eq!(
//                 none.extract::<OffsetDateTime<FixedOffset>>()
//                     .unwrap_err()
//                     .to_string(),
//                 "TypeError: 'NoneType' object cannot be converted to 'PyDateTime'"
//             );
