...
impl PyList {
    ...
    pub fn get_item(&self, index: usize) -> PyResult<&PyAny> {
        self.as_bound().get_item(index).map(Bound::into_gil_ref)
    }
    ...
    pub unsafe fn get_item_unchecked(&self, index: usize) -> &PyAny {
        self.as_bound().get_item_unchecked(index).into_gil_ref()
    }
    ...
    pub fn get_slice(&self, low: usize, high: usize) -> &PyList {
        self.as_bound().get_slice(low, high).into_gil_ref()
    }
    ...
    where
        I: ToPyObject,
    {
        self.as_bound().set_item(index, item)
    }
    ...
    pub fn set_slice(&self, low: usize, high: usize, seq: &PyAny) -> PyResult<()> {
        self.as_bound().set_slice(low, high, seq.as_bound())
    }
    ...
    pub fn del_slice(&self, low: usize, high: usize) -> PyResult<()> {
        self.as_bound().del_slice(low, high)
    }
    ...
    where
        I: ToPyObject,
    {
        self.as_bound().insert(index, item)
    }
    ...
    where
        V: ToPyObject,
    {
        self.as_bound().index(value)
    }

    /// Returns an iterator over this list's items.
    pub fn iter(&self) -> PyListIterator<'_> {
        PyListIterator(self.as_bound().iter())
    }
    ...
    pub fn to_tuple(&self) -> &PyTuple {
        self.as_bound().to_tuple().into_gil_ref()
    }
}
