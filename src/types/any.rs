...
use crate::types::{PyDict, PyIterator, PyString, PyTuple, PyType};
...
impl PyAny {
    ...
    pub fn is_empty(&self) -> PyResult<bool> {
        builtin_methods::len(self).map(|l| l == 0)
    }
    ...
    pub fn __repr__(&self) -> PyResult<&PyString> {
        builtin_methods::repr(self)
    }

    /// Computes the "str" representation of self.
    pub fn __str__(&self) -> PyResult<&PyString> {
        builtin_methods::str(self)
    }

    /// Retrieves the hash code of the object.
    pub fn __hash__(&self) -> PyResult<isize> {
        builtin_methods::hash(self)
    }

    /// Returns the length of the sequence or mapping.
    pub fn __len__(&self) -> PyResult<usize> {
        builtin_methods::len(self)
    }

    #[deprecated(since = "0.10.0", note = "Use self.__repr__() or pyo3::repr(self)")]
    pub fn repr(&self) -> PyResult<&PyString> {
        self.__repr__()
    }

    #[deprecated(since = "0.10.0", note = "Use self.__str__() or pyo3::str(self)")]
    pub fn str(&self) -> PyResult<&PyString> {
        self.__str__()
    }

    #[deprecated(since = "0.10.0", note = "Use self.__hash__() or pyo3::hash(self)")]
    pub fn hash(&self) -> PyResult<isize> {
        self.__hash__()
    }

    #[deprecated(since = "0.10.0", note = "Use self.__len__() or pyo3::len(self)")]
