...
pyobject_native_type_core!(PyCFunction, pyobject_native_static_type_object!(ffi::PyCFunction_Type), "builtin_function_or_method", #checkfunction=ffi::PyCFunction_Check);
...
#[cfg(not(Py_LIMITED_API))]
pyobject_native_type_core!(PyFunction, pyobject_native_static_type_object!(ffi::PyFunction_Type), "function", #checkfunction=ffi::PyFunction_Check);
