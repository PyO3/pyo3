...
pyobject_native_type_core!(PyCFunction, pyobject_native_static_type_object!(ffi::PyCFunction_Type), "PyCFunction", #checkfunction=ffi::PyCFunction_Check);
...
#[cfg(not(Py_LIMITED_API))]
pyobject_native_type_core!(PyFunction, pyobject_native_static_type_object!(ffi::PyFunction_Type), "PyFunction", #checkfunction=ffi::PyFunction_Check);
