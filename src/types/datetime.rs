...
impl<'py> PyDate<'py> {
    pub fn new(py: Python<'py>, year: i32, month: u8, day: u8) -> PyResult<Self> {
        unsafe {
    ...
    pub fn from_timestamp(py: Python<'py>, timestamp: i64) -> PyResult<Self> {
...
impl PyDeltaAccess for PyDelta<'_> {
    fn get_days(&self) -> i32 {
